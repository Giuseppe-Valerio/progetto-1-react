...
class FilmGallerySecondo extends Component {
  constructor(props) {
    super(props);
    this.state = {
      films: [],
  ...
  fetchGallery = async () => {
    try {
      const resp = await fetch("http://www.omdbapi.com/?s=potter&apikey=6a45bde1");
      if (resp.ok) {
...
export default FilmGallerySecondo;
